...
class AmbiguousTermCandidate(TypedDict):
    concept_id: str
    canonical: str
    concept_type: Literal["BUSINESS", "ACTION"]
    target_type: str | None
...
class NormalizationResult(TypedDict):
    ...
    normalization_status: Literal["NORMALIZED", "NEEDS_CLARIFICATION"]
    ambiguous_terms: list[AmbiguousTerm]


class NormalizationNodeResult(NormalizationResult, total=False):
    execution_allowed: bool
    error: str
    normalization_elapsed_ms: float
...
class OrchestratorState(TypedDict):
    ...
    normalization_status: NotRequired[Literal["NORMALIZED", "NEEDS_CLARIFICATION"]]
    ambiguous_terms: NotRequired[list[AmbiguousTerm]]
    normalization_elapsed_ms: NotRequired[float]
