...
from strict_query.snapshot.agents.cypher.schema.models import GraphSchema
from strict_query.snapshot.orchestrator.entity_types import (
    NamedEntityType,
        ...
        for index, (
            ...
            if entity is None:
                ...
                if candidates:
                    ...
                    raise EntityAmbiguousError(candidates, lookup_name=entity_name)
