        ...
        record.update(
            {
                ...
                "routeRepairCount": state.get("routeRepairCount", 0),
                "outputPlanRepairCount": state.get("outputPlanRepairCount", 0),
                "resultInvariantRetryCount": state.get("resultInvariantRetryCount", 0),
                "answerGeneration": state.get("answer_metadata"),
